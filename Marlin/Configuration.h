...
#define STRING_CONFIG_H_AUTHOR "(NOVAXIM, ANYCUBIC Mega Zero)" // Who made the changes.
 ...
 *    L |    (+) P  | R
 *    E |           | I
 *    F | (-) N (+) | G <-- nozzle (20,20) = probe (MIN_PROBE_EDGE - X_PROBE_OFFSET_FROM_EXTRUDER),(MIN_PROBE_EDGE - Y_PROBE_OFFSET_FROM_EXTRUDER)
 *    T |           | H
 *      |    (-)    | T
 *      |           |
 *      O-- FRONT --+
